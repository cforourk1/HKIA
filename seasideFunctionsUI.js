...
/*I am using a filter to go through the array and sorty the fish by rarity and ragion and return values based on user input. Ther could be mutiple filters selected.
*/
