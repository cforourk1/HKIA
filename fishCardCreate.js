...
*/
  ...
  // tags
  const tagNames = document.createElement("p");
  // this portion is the place holder for the name of the fish
  tagNames.className = "fishTags";
  // brings in the text I need
  tagNames.innerText = fish.tags.join(", ");
  elm.appendChild(tagNames);
  ...
  tinyLabel.innerText = "Tiny";
  tracker.appendChild(tinyLabel);

  const tinyCatch = document.createElement("input");
  tinyCatch.type = "checkbox";
  tracker.appendChild(tinyCatch);

  // regular section
  const regLabel = document.createElement("label");
  regLabel.innerText = "Regular";
  tracker.appendChild(regLabel);

  const regCatch = document.createElement("input");
  regCatch.type = "checkbox";
  tracker.appendChild(regCatch);

  // huge section
  const hugeLabel = document.createElement("label");
  hugeLabel.innerText = "Huge";
  tracker.appendChild(hugeLabel);

  const hugeCatch = document.createElement("input");
  hugeCatch.type = "checkbox";
  tracker.appendChild(hugeCatch);
  return elm;
}
